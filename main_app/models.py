...
from django.db.models.fields import DateTimeField, TextField, BooleanField, CharField
...
class Post(Model):
  ...
  age = CharField(max_length=150, blank=True)
  breed = CharField(max_length=200, blank=True)
  size = CharField(max_length=300, blank=True)
